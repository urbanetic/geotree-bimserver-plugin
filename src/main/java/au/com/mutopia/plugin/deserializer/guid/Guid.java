...
/**
 * This class is a simple data type used during the conversion between compressed and uncompressed string
 * representations of GUIDs use within the Industry Foundation Classes (IFC). It is equivalent to the struct _GUID in
 ...
 * <br>
 * The class Guid is part of the OPEN IFC JAVA TOOLBOX package. Copyright: CCPL BY-NC-SA 3.0 (cc) 2008 Eike Tauscher,
 * Jan Tulke <br>
 * <br>
